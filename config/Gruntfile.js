module.exports = function (grunt) {
    ...
    var taskConfig = {
        ...
        concat: {
            ...
            less:          {
                src:  [
                    '<%= build_dir %>/assets/less/structure.less',
                    '<%= build_dir %>/assets/less/breakpoints.less'
                ],
                dest: '<%= build_dir %>/assets/less/main.less'
            },
            lessstructure: {
                src:  [
                    '<%= src_dir %>/assets/less/_structure-reset.less',
                    '<%= src_dir %>/assets/less/_structure-main.less',
                    '<%= src_dir %>/assets/less/_structure-variables.less',
                    '<%= src_dir %>/assets/less/_structure-structure.less',
                    '<%= src_dir %>/assets/less/_structure-mixins.less',
                    '<%= src_dir %>/assets/less/_structure-grid.less',
                    '<%= src_dir %>/assets/less/_structure-basic.less',
                    '<%= src_dir %>/**/*variables*.less'
                ],
                dest: '<%= build_dir %>/assets/less/structure.less'
            },
            lessxs:        {
                src:  [
                    '<%= src_dir %>/**/*-xs.less'
            ...
            breakpoints:   {
                ...
                dest: '<%= build_dir %>/assets/less/breakpoints.less'
            },
            /**
